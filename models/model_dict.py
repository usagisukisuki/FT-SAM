...
#from models.segment_anything_SMadaptformer.build_sam import sam_smadaptformer_model_registry
...
def get_model(modelname="SAM", args=None):
    ...
    #elif modelname == "SAM_SMAdaptFormer":
    #    model = sam_smadaptformer_model_registry['vit_b'](args=args,checkpoint=args.sam_ckpt)
    #elif modelname == "GSAM":
